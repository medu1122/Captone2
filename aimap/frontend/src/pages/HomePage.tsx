    ...
    <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-display min-h-screen flex flex-col antialiased selection:bg-primary/30 selection:text-primary overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glassmorphism px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a className="text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors" href="#how-it-works">How it Works</a>
        ...
        <div className="flex items-center gap-4">
          <a className="hidden sm:block text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors" href="/login">Log in</a>
      ...
      <main className="flex-grow pt-24 mesh-gradient">
        ...
        <section className="relative max-w-7xl mx-auto px-6 pt-20 pb-32 flex flex-col items-center text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-tight mb-6 max-w-4xl">
            ...
            <span className="text-gradient">Zero Code. Zero Hassle.</span>
          </h1>
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl font-medium leading-relaxed">
            Our multi-agent AI orchestrates your branding, website, and social media from a single prompt. Build your entire digital presence in minutes.
          </p>
          ...
          <div className="w-full max-w-5xl relative perspective-1000">
            ...
            />
            <div className="absolute top-10 -left-10 bg-surface-dark border border-border-dark p-4 rounded-lg shadow-xl z-20 flex items-center gap-3 hidden md:flex">
              <div className="w-10 h-10 rounded bg-green-500/20 text-green-500 flex items-center justify-center">
                <span className="material-symbols-outlined">check_circle</span>
              </div>
              <div>
                <p className="text-xs text-slate-400">Website Generated</p>
                <p className="text-sm font-bold text-white">In 2.4 seconds</p>
              </div>
            </div>
            <div className="absolute bottom-20 -right-8 bg-surface-dark border border-border-dark p-4 rounded-lg shadow-xl z-20 flex items-center gap-3 hidden md:flex">
              <div className="w-10 h-10 rounded bg-blue-500/20 text-blue-500 flex items-center justify-center">
                <span className="material-symbols-outlined">campaign</span>
              </div>
              <div>
                <p className="text-xs text-slate-400">Social Campaign</p>
                <p className="text-sm font-bold text-white">Scheduled for 9:00 AM</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 border-y border-border-dark bg-surface-dark/50">
          <div className="max-w-7xl mx-auto px-6">
            <p className="text-center text-sm font-semibold text-slate-500 uppercase tracking-widest mb-8">Trusted by modern small businesses</p>
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto" id="features">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">AIMAP&apos;s multi-agent AI builds your brand, website, and marketing campaigns in minutes, acting as your entire marketing department.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px]">
            <div className="md:col-span-2 bg-surface-dark border border-border-dark rounded-2xl p-8 card-glow flex flex-col justify-between overflow-hidden relative group">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-2">Unified Input</h3>
                <p className="text-slate-400">Describe your business once. Our AI agents analyze your prompt to extract core brand values, target audience, and key offerings.</p>
              </div>
            ...
            <div className="md:col-span-1 bg-surface-dark border border-border-dark rounded-2xl p-8 card-glow flex flex-col justify-between overflow-hidden relative group">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-bold mb-2">AI Branding</h3>
                <p className="text-slate-400 text-sm">Get beautiful logo concepts, typography, and brand colors instantly generated based on your business profile.</p>
              </div>
            </div>
            <div className="md:col-span-1 bg-surface-dark border border-border-dark rounded-2xl p-8 card-glow flex flex-col justify-between overflow-hidden relative group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-400 text-sm">Launch a stunning, high-converting, fully responsive website with zero code required.</p>
              </div>
            </div>
            <div className="md:col-span-2 bg-surface-dark border border-border-dark rounded-2xl p-8 card-glow flex flex-col justify-between overflow-hidden relative group">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-2xl font-bold mb-2">Facebook Auto-Publish</h3>
                <p className="text-slate-400">Generate, schedule, and auto-publish engaging social posts effortlessly to keep your audience engaged.</p>
        ...
        <section className="py-24 bg-surface-dark/30 border-y border-border-dark" id="how-it-works">
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">How AIMAP Works</h2>
              <p className="text-slate-400">From prompt to production in three simple steps.</p>
            </div>
            <div className="relative pl-8 md:pl-0">
              ...
              <div className="relative flex flex-col md:flex-row items-center justify-between mb-16 w-full">
                <div className="md:w-5/12 text-left md:text-right pr-0 md:pr-8 mb-4 md:mb-0 ml-8 md:ml-0">
                  <h3 className="text-xl font-bold mb-2">1. The Input</h3>
                  <p className="text-slate-400 text-sm">Simply describe your business, target audience, and goals in plain English.</p>
                </div>
                ...
                <div className="md:w-5/12 pl-0 md:pl-8 ml-8 md:ml-0">
                  <div className="bg-surface-dark border border-border-dark p-4 rounded-xl">
                    ...
                    <p className="text-sm">&quot;I&apos;m opening a specialty coffee shop in Brooklyn focusing on fair-trade, organic roasts.&quot;</p>
                  </div>
                </div>
              </div>
              <div className="relative flex flex-col md:flex-row items-center justify-between mb-16 w-full">
                <div className="md:w-5/12 text-left pr-0 md:pr-8 mb-4 md:mb-0 ml-8 md:ml-0 order-1 md:order-2">
                  <h3 className="text-xl font-bold mb-2">2. AI Orchestration</h3>
                  <p className="text-slate-400 text-sm">Our agents break down your prompt, drafting copy, designing assets, and structuring your site.</p>
                </div>
              ...
              <div className="relative flex flex-col md:flex-row items-center justify-between w-full">
                <div className="md:w-5/12 text-left md:text-right pr-0 md:pr-8 mb-4 md:mb-0 ml-8 md:ml-0">
                  <h3 className="text-xl font-bold mb-2">3. Deploy &amp; Automate</h3>
                  <p className="text-slate-400 text-sm">Review the generated assets, click deploy, and let the AI handle your ongoing marketing schedule.</p>
                </div>
        ...
        <section className="py-32 px-6 max-w-5xl mx-auto" id="pricing">
          <div className="bg-gradient-to-br from-primary/20 via-purple-500/10 to-surface-dark border border-border-dark rounded-3xl p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-300 mb-10 text-lg max-w-2xl mx-auto">Stop juggling multiple tools and agencies. Let AIMAP handle your marketing so you can focus on what you do best.</p>
      ...
      <footer className="bg-background-dark border-t border-border-dark py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-sm text-slate-500 text-center md:text-left">
            Capstone Project - AIMAP © 2024. All rights reserved.
          </p>
